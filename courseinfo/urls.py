"""youn_ben_ezu URL Configuration
...
from courseinfo.views import InstructorList, SectionList, CourseList, SemesterList, StudentList, RegistrationList, \
    SemesterCreate, StudentCreate, RegistrationCreate, CourseUpdate, SemesterUpdate, StudentUpdate, RegistrationUpdate, \
    RegistrationDelete, InstructorDelete, SectionDelete, CourseDelete, SemesterDelete, StudentDelete
from courseinfo.views import InstructorDetail, SectionDetail, SemesterDetail, CourseDetail, StudentDetail, RegistrationDetail
from courseinfo.views import InstructorCreate, SectionCreate, CourseCreate
from courseinfo.views import InstructorUpdate, SectionUpdate
